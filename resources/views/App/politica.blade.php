...
<nav class="navbar navbar-expand-lg navbar-dark pb_navbar pb_scrolled-light" id="pb-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="probootstrap-navbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="{{url('/areas')}}">Areas</a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
      ...
      <div class="row align-items-center justify-content-end">
        <div class="col-md-6  order-md-1">
          ...
          <h2 class="heading mb-3">Politica de privacidad</h2>
  ...
  <section  class="pb_section bg-light" >
      <div class="container">
            <h3 class="pb-4">1.INFORMACIÓN AL USUARIO</h3>
                <p>Noelia Custodio, como Responsable del Tratamiento, le informa que, según lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril, (RGPD) y en la L.O. 3/2018, de 5 de diciembre, de protección de datos y garantía de los derechos digitales (LOPDGDD), trataremos su datos tal y como reflejamos en la presente Política de Privacidad.
                </p><p>
            ...
            <h3 class="pb-4 pt-4">2. CONTACTO</h3>
            <p>Denominación social: Noelia Custodio Abogada</p>
            <p>Domicilio: C/ Maldonado, 25, 11370 Los Barrios, Cádiz</p>
            <p>e-mail: noelia.custodiogomez@gmail.com</p>

            <h3 class="pb-4 pt-4">3. PRINCIPIOS CLAVE</h3>
            ...
            <h3 class="pb-4 pt-4">4. RECOGIDA Y TRATAMIENTO DE SUS DATOS PERSONALES</h3>
            ...
            <h3 class="pb-4 pt-4">5. LEGITIMIDAD</h3>
            <p>De acuerdo con la normativa de protección de datos aplicable, sus datos personales podrán tratarse siempre que:</p>
            <ul>
                <li>Nos ha dado su consentimiento a los efectos del tratamiento. Por supuesto podrá retirar su consentimiento en cualquier momento.
                </li>
                <li>Por requerimiento legal.
                </li>
                <li>Por exisitr un interés legítimo que no se vea menoscabado por sus derechos de privacidad, como por ejemplo el envío de información comercial bien por suscripción a nuestra newsletter o por su condición de cliente.
                </li>
                <li>Por se necesaria para la prestación de alguno de nuestros servicios mediante relación contractual entre usted y nosotros.
                </li>
            </ul>
            <h3 class="pb-4 pt-4">6. COMUNICACIÓN DE DATOS PERSONALES</h3>
            <p>Los datos pueden ser comunicados a empresas relacionadas con Noelia Custodio para la prestación de los diversos servicios en calidad de Encargados del Tratamiento. La empresa no realizará ninguna cesión, salvo por obligación legal.
            </p>
            <h3 class="pb-4 pt-4">7. SUS DERECHOS</h3>
            ...
            <ul>
                ...
                <li>Rectificar sus datos personales que sean inexactos o estén incompletos de acuerdo con el Artículo 16 del RGPD.
                </li>
                <li>Suprimir sus datos personales de acuerdo con el Artículo 17 del RGPD.
                </li>
                <li>Limitar el tratamiento de sus datos personales de acuerdo con el Artículo 18 del RGPD.
                </li>
                <li>Solicitar la portabilidad de sus datos de acuerdo con el Artículo 20 del RGPD.
                </li>
                <li>Oponerse al tratamiento de sus datos personales de acuerdo con el artículo 21 del RGPD.
                </li>
            </ul>
            <p>Si ha otorgado su consentimiento para alguna finalidad concreta, tiene derecho a retirar el consentimiento otorgado en cualquier momento, sin que ello afecte a la licitud del tratamiento basado en el consentimiento previo a su retirada.
            </p>
            <p>Puede ejercer estos derechos enviando comunicación, motivada y acreditada, a noelia.custodiogomez@gmail.com </p>
            ...
            <h3 class="pb-4 pt-4">8. INFORMACIÓN LEGAL</h3>
